...
#include "midiglue.h"            // you have to include the Gnusbuino MIDI library
...
void setup() {               
  pinMode(13,OUTPUT);         // Pin 3 (and 4) on the Gnusbuino has a PWM ("analog") output
}
